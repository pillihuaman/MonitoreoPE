...
namespace Monitoreo.Models.Mail
{
    public class MailSend
    {
        public static String SenMail(Monitoreo.DataBussiness.Mail objMail)
        {
        ...
        public static String SenMailNoAttachments(Monitoreo.DataBussiness.Mail objMail)
        {
            string SendErro = string.Empty;
